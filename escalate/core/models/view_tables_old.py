...
class Actor(models.Model):
    ...
    systemtool_description = models.CharField(max_length=255, blank=True, null=True)
    ...
    systemtool_version = models.CharField(max_length=255, blank=True, null=True)
...
class Inventory(models.Model):
    ...
    operator_description = models.CharField(max_length=255, blank=True, null=True)
...
class InventoryMaterial(models.Model):
    ...
    inventory_description = models.CharField(max_length=255, blank=True, null=True)
    ...
    actor = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="inventory_material_actor",
    )
...
class Systemtool(models.Model):
    ...
    organization_fullname = models.CharField(max_length=255, blank=True, null=True)
...
class Calculation(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="calculation_uuid")
    in_val = ValField(blank=True, null=True)
    # in_val = CharField(max_length=255, blank=True, null=True)
    in_val_type = models.ForeignKey(
        "TypeDef",
        models.DO_NOTHING,
    ...
    in_opt_val_type = models.ForeignKey(
        "TypeDef",
        models.DO_NOTHING,
    ...
    out_val_type = models.ForeignKey(
        "TypeDef",
        models.DO_NOTHING,
    ...
    systemtool_vendor_organization = models.CharField(
        ...
        blank=True,
        null=True,
        db_column="systemtool_vendor_organization",
    )
    systemtool_version = models.CharField(max_length=1023, blank=True, null=True)
    ...
    actor_description = models.CharField(max_length=1023, blank=True, null=True)
    add_date = models.DateTimeField(auto_now_add=True)
    mod_date = models.DateTimeField(auto_now=True)
...
class Material(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="material_uuid")
    description = models.CharField(max_length=255, blank=True, null=True)
...
class Mixture(models.Model):
    ...
    property = models.ManyToManyField(
        "Property",
        through="CompositeMaterialProperty",
        related_name="composite_material_property",
...
class BomMaterial(models.Model):
    ...
    actor = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="bom_material_actor",
    )
    status = models.ForeignKey(
        "Status",
        on_delete=models.DO_NOTHING,
        ...
        null=True,
        editable=False,
        related_name="bom_material_status",
    )
    add_date = models.DateTimeField(auto_now_add=True)
    mod_date = models.DateTimeField(auto_now=True)
...
class BomCompositeMaterial(models.Model):
    ...
    composite_material = models.ForeignKey(
        "Mixture",
        on_delete=models.DO_NOTHING,
        blank=True,
        null=True,
    ...
    actor = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="bom_composite_material_actor",
    )
    status = models.ForeignKey(
        "Status",
        on_delete=models.DO_NOTHING,
        ...
        null=True,
        editable=False,
        related_name="bom_composite_material_status",
    )
    add_date = models.DateTimeField(auto_now_add=True)
    mod_date = models.DateTimeField(auto_now=True)
...
class MaterialCalculationJson(models.Model):
    ...
    inchi = models.CharField(db_column="inchi", max_length=255, blank=True, null=True)
    ...
    smiles = models.CharField(db_column="smiles", max_length=255, blank=True, null=True)
...
class MaterialRefnameDef(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="material_refname_def_uuid")
    description = models.CharField(max_length=255, blank=True, null=True)
    add_date = models.DateTimeField(auto_now_add=True)
    mod_date = models.DateTimeField(auto_now=True)
...
class Note(models.Model):
    ...
    mod_date = models.DateTimeField(auto_now=True)
    actor = models.ForeignKey(
        "Actor", models.DO_NOTHING, db_column="actor_uuid", related_name="note_actor"
    )
    actor_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
...
class Organization(models.Model):
    ...
    parent_org_full_name = models.CharField(max_length=255, blank=True, null=True)
    add_date = models.DateTimeField(auto_now_add=True)
    mod_date = models.DateTimeField(auto_now=True)
...
class Person(models.Model):
    ...
    organization_full_name = models.CharField(max_length=255, blank=True, null=True)
...
class Edocument(models.Model):
    ...
    doc_type_description = models.CharField(
    ...
    doc_type_uuid = models.ForeignKey(
        "TypeDef",
...
class Experiment(models.Model):
    ...
    parent = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="experiment_parent",
    )
    owner = models.ForeignKey(
        "Actor",
        db_column="owner_uuid",
    ...
    status = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="experiment_status",
    )
    status_description = models.CharField(
        max_length=255,
        blank=True,
...
class ExperimentWorkflow(models.Model):
    ...
    experiment = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="experiment_workflow_experiment",
    )
    ...
    workflow = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="experiment_workflow_workflow",
    )
    workflow_type_uuid = models.ForeignKey(
        "WorkflowType",
...
class Outcome(models.Model):
    ...
    experiment = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="outcome_experiment",
    )
    actor = models.ForeignKey(
        "Actor",
        models.DO_NOTHING,
...
class UdfDef(models.Model):
    ...
    val_type_description = models.CharField(max_length=255, blank=True, null=True)
...
class Property(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="property_uuid")
    ...
    property_def = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="property_property_def",
    )
    short_description = models.CharField(
        max_length=255, blank=True, null=True, db_column="short_description"
    )

    property_val = models.CharField(
        max_length=255, blank=True, null=True, db_column="property_val"
    )
    """
...
class PropertyDef(models.Model):
    ...
    val_unit = models.CharField(
        max_length=255, blank=True, null=True, db_column="valunit"
    )
    actor = models.ForeignKey(
        "Actor",
        on_delete=models.DO_NOTHING,
...
class MaterialProperty(models.Model):
    ...
    uuid = RetUUIDField(primary_key=True, db_column="property_x_uuid")
    material = models.ForeignKey(
        "Material",
        db_column="material_uuid",
        on_delete=models.DO_NOTHING,
        blank=True,
        null=True,
        related_name="material_property_material",
    )
    description = models.CharField(
        max_length=255, blank=True, null=True, db_column="description", editable=False
    )
    ...
    property_def = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="material_property_property_def",
    )
    ...
    actor = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="material_property_actor",
    )
    actor_description = models.CharField(
        max_length=255,
        blank=True,
...
class CompositeMaterialProperty(models.Model):
    ...
    composite_material_description = models.CharField(
        max_length=255, blank=True, null=True, db_column="description", editable=False
    )
    component = models.ForeignKey(
        "Mixture",
    ...
    property_def = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="composite_material_property_property_def",
    )
    property_description = models.CharField(
        max_length=255,
        blank=True,
    ...
    value = ValField(blank=True, null=True, db_column="val_val")
    actor = models.ForeignKey(
        "Actor",
        on_delete=models.DO_NOTHING,
        db_column="property_actor_uuid",
        ...
        null=True,
        editable=False,
        related_name="composite_material_property_actor",
    )
    actor_description = models.CharField(
        max_length=255,
        blank=True,
...
class ParameterDef(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="parameter_def_uuid")
    description = models.CharField(
        max_length=255, blank=True, null=True, db_column="description", editable=False
    )
    ...
    val_type = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="parameter_def_val_type",
    )
    default_val_val = models.CharField(
        max_length=255,
        blank=True,
        null=True,
    ...
    valunit = models.CharField(
        max_length=255, blank=True, null=True, db_column="valunit", editable=False
    )
    """
    default_val = ValField(
                           ...
                           editable=False)
    """
    default_val = models.CharField(
        max_length=255, blank=True, null=True, db_column="default_val", editable=False
    )
    required = models.CharField(
        max_length=255, blank=True, null=True, db_column="required", editable=False
    )
    actor = models.ForeignKey(
        "Actor",
        on_delete=models.DO_NOTHING,
...
class Condition(models.Model):
    ...
    condition_def = models.ForeignKey(
        "ConditionDef",
        models.DO_NOTHING,
        db_column="condition_def_uuid",
        related_name="condition_condition_def",
    )
    calculation_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    ...
    in_val = models.CharField(max_length=255, blank=True, null=True, editable=False)
    out_val = models.CharField(max_length=255, blank=True, null=True, editable=False)
...
class ConditionDef(models.Model):
    ...
    actor = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="condition_def_actor",
    )
    actor_description = models.CharField(
        max_length=255,
        blank=True,
    ...
    status = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="condition_def_status",
    )
    add_date = models.DateTimeField(auto_now_add=True)
    mod_date = models.DateTimeField(auto_now=True)
...
class ActionParameterDef(models.Model):
    ...
    action_def = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="action_parameter_def_action_def",
    )
    ...
    actor = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="action_parameter_def_actor",
    )
    actor_description = models.CharField(
        max_length=255,
        blank=True,
    ...
    status = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="action_parameter_def_status",
    )
    status_description = models.CharField(
        max_length=255,
        blank=True,
    ...
    parameter_def = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="action_parameter_def_parameter_def",
    )

    parameter_description = models.CharField(
        max_length=255,
        blank=True,
        null=True,
    ...
    parameter_val_type = models.ForeignKey(
        "TypeDef",
        db_column="parameter_val_type_uuid",
        on_delete=models.DO_NOTHING,
        blank=True,
        null=True,
        related_name="action_parameter_def_parameter_val_type",
    )
...
class ActionParameterDefAssign(models.Model):
    ...
    action_def = models.ForeignKey(
        ...
        editable=False,
        db_column="action_def_uuid",
        related_name="action_parameter_def_assign_action_def",
    )
    add_date = models.DateTimeField(auto_now_add=True)
    mod_date = models.DateTimeField(auto_now=True)
...
class Action(models.Model):
    action_uuid = RetUUIDField(primary_key=True, db_column="action_uuid")
    parameter = models.ManyToManyField(
        "ActionParameter",
        through="ActionParameterAssign",
        related_name="action_parameter",
    )
    description = models.CharField(
        max_length=255, blank=True, null=True, db_column="action_description"
    )
    action_def = models.ForeignKey(
        "ActionDef",
        on_delete=models.DO_NOTHING,
...
class ActionParameter(models.Model):
    ...
    parameter_def = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="action_parameter_parameter_def",
    )
    ...
    parameter_val_nominal = ValField(
        blank=True, null=True, db_column="parameter_val_nominal"
    )
    actor = models.ForeignKey(
        "Actor",
        on_delete=models.DO_NOTHING,
        ...
        null=True,
        editable=False,
        related_name="action_parameter_actor",
    )
    actor_description = models.CharField(
        max_length=255,
        blank=True,
    ...
    status = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="action_parameter_status",
    )
    status_description = models.CharField(
        max_length=255,
        blank=True,
...
class WorkflowType(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="workflow_type_uuid")
    description = models.CharField(
        max_length=255, blank=True, null=True, db_column="description", editable=False
    )
    add_date = models.DateTimeField(auto_now_add=True, db_column="add_date")
...
class Workflow(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="workflow_uuid")
    ...
    workflow_type = models.ForeignKey(
        ...
        null=True,
        db_column="workflow_type_uuid",
        related_name="workflow_workflow_type",
    )
    workflow_type_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    actor = models.ForeignKey(
        "Actor",
...
class WorkflowStep(models.Model):
    uuid = RetUUIDField(primary_key=True, db_column="workflow_step_uuid")
    workflow = models.ForeignKey(
        "Workflow",
        models.DO_NOTHING,
        db_column="workflow_uuid",
    ...
    workflow_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    parent = models.ForeignKey(
        "WorkflowStep",
        ...
        editable=False,
        db_column="parent_uuid",
        related_name="workflow_step_parent",
    )
    parent_object_type = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    parent_object_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    parent_path = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    conditional_val = ValField(blank=True, null=True, editable=False)
    ...
    workflow_object = models.ForeignKey(
        ...
        related_name="workflow_step_workflow_object",
    )
...
class WorkflowObject(models.Model):
    ...
    action = models.ForeignKey(
        ...
        editable=False,
        db_column="action_uuid",
        related_name="workflow_object_action",
    )
    condition = models.ForeignKey(
        ...
        related_name="workflow_object_condition",
    )
    ...
    object_def_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    add_date = models.DateTimeField(auto_now_add=True, db_column="add_date")
    mod_date = models.DateTimeField(auto_now=True, db_column="mod_date")
...
class MeasureType(models.Model):
    ...
    actor_uuid = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="measure_type_actor",
    )
    actor_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
    status_uuid = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="measure_type_status",
    )
    status_description = models.CharField(
        max_length=255, blank=True, null=True, editable=False
    )
