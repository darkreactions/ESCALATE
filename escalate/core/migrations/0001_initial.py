# Generated by Django 3.0.14 on 2021-06-04 14:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', core.models.custom_types.ValField(blank=True, db_column='property_value_val', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bomcompositematerial_actor', to='core.Actor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bommaterial_actor', to='core.Actor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calculation_def', models.ForeignKey(blank=True, db_column='calculation_def_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='condition_calculation_def_assign_calculation_def', to='core.CalculationDef')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='parameter_x_parameter', to='core.Parameter')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='parameter_def',
            field=models.ForeignKey(blank=True, db_column='parameter_def_uuid', editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='parameter_parameter_def', to='core.ParameterDef'),
        ),
        migrations.AddField(
            model_name='parameter',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='parameter_status', to='core.Status'),
        ),
        migrations.CreateModel(
            name='Outcome',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflow', models.ForeignKey(blank=True, db_column='workflow_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='experiment_workflow_workflow', to='core.Workflow')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calculation_def', models.ManyToManyField(through='core.ConditionCalculationDefAssign', to='core.CalculationDef')),
        ...
        migrations.AddField(
            model_name='conditioncalculationdefassign',
            name='condition_def',
            field=models.ForeignKey(blank=True, db_column='condition_def_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='condition_calculation_def_assign_condition_def', to='core.ConditionDef'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ManyToManyField(related_name='composite_material_property', through='core.CompositeMaterialProperty', to='core.Property')),
        ...
        migrations.AddField(
            model_name='calculationdef',
            name='in_opt_type',
            field=models.ForeignKey(db_column='in_opt_type_uuid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='calculation_def_in_opt_type', to='core.TypeDef'),
        ),
        migrations.AddField(
            model_name='calculationdef',
            name='in_source',
            field=models.ForeignKey(db_column='in_source_uuid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='calculation_def_in_source', to='core.CalculationDef'),
        ),
        migrations.AddField(
            model_name='calculationdef',
            name='in_type',
            field=models.ForeignKey(db_column='in_type_uuid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='calculation_def_in_type', to='core.TypeDef'),
        ),
        migrations.AddField(
            model_name='calculationdef',
            name='out_type',
            field=models.ForeignKey(blank=True, db_column='out_type_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='calculation_def_out_type', to='core.TypeDef'),
        ),
        migrations.AddField(
            model_name='calculationdef',
            name='parameter_def',
            field=models.ManyToManyField(related_name='calculation_def_parameter_def', through='core.CalculationParameterDefAssign', to='core.ParameterDef'),
        ),
        migrations.AddField(
            model_name='calculationdef',
            name='systemtool',
            field=models.ForeignKey(db_column='systemtool_uuid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='calculation_def_systemtool', to='core.Systemtool'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            name='BomMaterialIndex',
            fields=[
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('mod_date', models.DateTimeField(auto_now=True)),
                ('uuid', core.models.core_tables.RetUUIDField(db_column='bom_material_index_uuid', default=uuid.uuid4, primary_key=True, serialize=False)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('bom_composite_material', models.ForeignKey(blank=True, db_column='bom_material_composite_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bom_composite_index_bom_composite_material', to='core.BomCompositeMaterial')),
                ('bom_material', models.ForeignKey(blank=True, db_column='bom_material_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bom_composite_index_bom_material', to='core.BomMaterial')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='inventory_material_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bom_material_inventory_material', to='core.InventoryMaterial'),
        ),
        migrations.AddField(
            model_name='bommaterial',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bommaterial_status', to='core.Status'),
        ),
        migrations.AddField(
            model_name='bomcompositematerial',
            name='bom_material',
            field=models.ForeignKey(blank=True, db_column='bom_material_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bom_composite_material_bom_material', to='core.BomMaterial'),
        ),
        migrations.AddField(
            model_name='bomcompositematerial',
            name='composite_material',
            field=models.ForeignKey(blank=True, db_column='material_composite_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bom_composite_material_composite_material', to='core.CompositeMaterial'),
        ),
        migrations.AddField(
            model_name='bomcompositematerial',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bomcompositematerial_status', to='core.Status'),
        ),
        migrations.AddField(
            model_name='billofmaterials',
            name='experiment',
            field=models.ForeignKey(blank=True, db_column='experiment_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='bom_experiment', to='core.Experiment'),
        ),
        migrations.AddField(
            model_name='billofmaterials',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='billofmaterials_status', to='core.Status'),
        ),
        migrations.CreateModel(
            name='ActorPref',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination_material', models.ForeignKey(blank=True, db_column='destination_material_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_unit_destination_material', to='core.BomMaterial')),
                ('parameter', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_unit_parameter', to='core.Parameter')),
                ('source_material', models.ForeignKey(blank=True, db_column='source_material_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_unit_source_material', to='core.BomMaterial')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_def', models.ForeignKey(blank=True, db_column='action_def_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_parameter_def_assign_action_def', to='core.ActionDef')),
                ('parameter_def', models.ForeignKey(blank=True, db_column='parameter_def_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_parameter_def_assign_parameter_def', to='core.ParameterDef')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_def', models.ForeignKey(blank=True, db_column='action_def_uuid', editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_parameter_def_action_def', to='core.ActionDef')),
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='actionparameterdef_actor', to='core.Actor')),
                ('parameter_def', models.ForeignKey(blank=True, db_column='parameter_def_uuid', editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_parameter_def_parameter_def', to='core.ParameterDef')),
                ('parameter_val_type', models.ForeignKey(blank=True, db_column='parameter_val_type_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_parameter_def_parameter_val_type', to='core.TypeDef')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='actionparameterdef_status', to='core.Status')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='actiondef',
            name='parameter_def',
            field=models.ManyToManyField(through='core.ActionParameterDefAssign', to='core.ParameterDef'),
        ),
        migrations.AddField(
            model_name='actiondef',
            name='status',
