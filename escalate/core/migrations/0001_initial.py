# Generated by Django 3.0.14 on 2021-09-29 02:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', core.models.core_tables.RetUUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description'])),
                ('value_descriptions', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=1024, null=True), blank=True, null=True, size=None)),
                ('material_type', models.ManyToManyField(blank=True, related_name='reagent_template_material_type', to='core.MaterialType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_instance_value_material_type', to='core.MaterialType')),
                ('reagent_instance', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_instance_value_reagent_instance', to='core.ReagentInstance')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagentinstancevalue_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_instance_reagent_template', to='core.ReagentTemplate'),
        ),
        migrations.AddField(
            model_name='reagentinstance',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagentinstance_status', to='core.Status'),
        ),
        migrations.CreateModel(
            name='PropertyDef',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(blank=True, db_column='experiment_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='outcome_experiment', to='core.ExperimentTemplate')),
                ('experiment_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='outcome_experiment_instance', to='core.ExperimentInstance')),
