# Generated by Django 3.0.14 on 2021-10-08 04:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['uuid', 'destination_material__internal_slug'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_nominal_value', core.models.custom_types.ValField(blank=True, null=True)),
                ('default_actual_value', core.models.custom_types.ValField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_instance_workflow_experiment', to='core.ExperimentInstance')),
                ('experiment_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_template_workflow_experiment', to='core.ExperimentTemplate')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='ReagentMaterialInstance',
            fields=[
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('mod_date', models.DateTimeField(auto_now=True)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('uuid', core.models.core_tables.RetUUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_instance_experiment_instance', to='core.ExperimentInstance')),
                ('material', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_instance_value_inventory_material', to='core.InventoryMaterial')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('uuid', core.models.core_tables.RetUUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('material_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_template_material_type', to='core.MaterialType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ManyToManyField(related_name='workflow_experiment', through='core.ExperimentWorkflow', to='core.ExperimentTemplate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('uuid', core.models.core_tables.RetUUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('default_value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_template_default_values', to='core.DefaultValues')),
                ('reagent_material_template', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_value_template_reagent_material_template', to='core.ReagentMaterialTemplate')),
        ...
        migrations.CreateModel(
            name='ReagentMaterialValueInstance',
            fields=[
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('mod_date', models.DateTimeField(auto_now=True)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('nominal_value', core.models.custom_types.ValField(blank=True, null=True)),
                ('actual_value', core.models.custom_types.ValField(blank=True, null=True)),
                ('reagent_material_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_value_instance_reagent_material_instance', to='core.ReagentMaterialInstance')),
                ('reagent_material_value_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_value_instance_reagent_material_value_template', to='core.ReagentMaterialValueTemplate')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagentmaterialvalueinstance_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_template_reagent_template', to='core.ReagentTemplate'),
        ),
        migrations.AddField(
            model_name='reagentmaterialtemplate',
            name='status',
        ...
        migrations.AddField(
            model_name='reagentmaterialinstance',
            name='reagent_material_template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_instance_reagent_material_template', to='core.ReagentMaterialTemplate'),
        ),
        migrations.AddField(
            model_name='reagentmaterialinstance',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagentmaterialinstance_status', to='core.Status'),
        ),
        migrations.CreateModel(
            name='PropertyDef',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='outcome_instance_outcome_template', to='core.OutcomeTemplate'),
        ),
        migrations.AddField(
            model_name='outcomeinstance',
            name='status',
        ...
        migrations.AddField(
            model_name='experimenttemplate',
            name='workflow',
            field=models.ManyToManyField(related_name='experiment_template_workflow', through='core.ExperimentWorkflow', to='core.Workflow'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='experimentinstance',
            name='workflow',
            field=models.ManyToManyField(related_name='experiment_instance_workflow', through='core.ExperimentWorkflow', to='core.Workflow'),
        ),
        migrations.CreateModel(
            name='EdocumentX',
            fields=[
