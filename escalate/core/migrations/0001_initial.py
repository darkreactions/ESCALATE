# Generated by Django 3.0.8 on 2021-10-21 15:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter_value', models.CharField(blank=True, db_column='reaction_parameter_profile_parameter_value', max_length=255, null=True)),
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reactionparameterprofile_actor', to='core.Actor')),
                ...
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reactionparameterprofile_status', to='core.Status')),
                ('workflow', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reaction_parameter_profile_workflow', to='core.Workflow')),
            ],
            options={
                'abstract': False,
            },
