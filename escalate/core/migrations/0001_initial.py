# Generated by Django 3.0.14 on 2021-08-03 00:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination_material', models.ForeignKey(blank=True, db_column='destination_material_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_unit_destination_material', to='core.BaseBomMaterial')),
                ('source_material', models.ForeignKey(blank=True, db_column='source_material_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_unit_source_material', to='core.BaseBomMaterial')),
