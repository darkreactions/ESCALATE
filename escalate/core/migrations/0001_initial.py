# Generated by Django 3.0.8 on 2021-09-13 14:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description', 'workflow', 'action_def__internal_slug'])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['source_material__internal_slug', 'action__internal_slug', 'destination_material__internal_slug'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_val', core.models.custom_types.ValField(blank=True, null=True)),
                ('out_val', core.models.custom_types.ValField(blank=True, null=True)),
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['condition_description'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['experiment__internal_slug', 'workflow__internal_slug', 'experiment_workflow_seq'])),
                ('experiment', models.ForeignKey(blank=True, db_column='experiment_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_workflow_experiment', to='core.Experiment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dead_volume', models.CharField(blank=True, max_length=255, null=True)),
                ('well_number', models.CharField(blank=True, max_length=16, null=True)),
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['plate_name', 'well_number'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, db_column='parent_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_parent', to='core.Workflow')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_def', models.ForeignKey(blank=True, db_column='action_def_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_action_set_action_def', to='core.ActionDef')),
                ...
                ('calculation', models.ForeignKey(blank=True, db_column='calculation_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_action_set_calculation', to='core.Calculation')),
                ('parameter_def', models.ForeignKey(blank=True, db_column='parameter_def_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_action_set_parameter_def', to='core.ParameterDef')),
                ...
                ('workflow', models.ForeignKey(blank=True, db_column='workflow_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_action_set_workflow', to='core.Workflow')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['workflow__internal_slug', 'action__internal_slug', 'condition__internal_slug'])),
                ('action', models.ForeignKey(blank=True, db_column='action_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_object_action', to='core.Action')),
                ('condition', models.ForeignKey(blank=True, db_column='condition_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_object_condition', to='core.Condition')),
                ...
                ('workflow', models.ForeignKey(blank=True, db_column='workflow_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_object_workflow', to='core.Workflow')),
                ('workflow_action_set', models.ForeignKey(blank=True, db_column='workflow_action_set_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_object_workflow_action_set', to='core.WorkflowActionSet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['workflow__internal_slug', 'action__internal_slug'])),
                ('action', models.ForeignKey(blank=True, db_column='action_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_step_action', to='core.Action')),
                ('parent', models.ForeignKey(blank=True, db_column='parent_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_step_parent', to='core.Workflow')),
                ...
                ('workflow', models.ForeignKey(db_column='workflow_uuid', on_delete=django.db.models.deletion.CASCADE, related_name='workflow_step_workflow', to='core.Workflow')),
                ('workflow_object', models.ForeignKey(db_column='workflow_object_uuid', on_delete=django.db.models.deletion.CASCADE, related_name='workflow_step_workflow_object', to='core.WorkflowObject')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='workflow',
            name='workflow_type',
            field=models.ForeignKey(blank=True, db_column='workflow_type_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workflow_workflow_type', to='core.WorkflowType'),
        ),
        migrations.CreateModel(
            name='VesselObject',
            fields=[
                ...
                ('mod_date', models.DateTimeField(auto_now=True)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('uuid', core.models.core_tables.RetUUIDField(db_column='vessel_object_uuid', default=uuid.uuid4, primary_key=True, serialize=False)),
                ('contents', models.CharField(blank=True, max_length=255, null=True)),
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vesselobject_actor', to='core.Actor')),
                ('model_uuid', models.ForeignKey(blank=True, db_column='vessel_model_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vessel_object_vessel_model_uuid', to='core.Vessel')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vesselobject_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(blank=True, db_column='experiment_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='outcome_experiment', to='core.Experiment')),
        ...
        migrations.AddField(
            ...
            name='workflow',
            field=models.ForeignKey(blank=True, db_column='workflow_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_workflow_workflow', to='core.Workflow'),
        ),
        migrations.CreateModel(
            name='ExperimentType',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='experiment_type_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_experiment_type', to='core.ExperimentType'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='lab',
            field=models.ForeignKey(blank=True, db_column='lab_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_lab', to='core.Actor'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='operator',
            field=models.ForeignKey(blank=True, db_column='operator_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_operator', to='core.Actor'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='owner',
            field=models.ForeignKey(blank=True, db_column='owner_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_owner', to='core.Actor'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='parent',
            field=models.ForeignKey(blank=True, db_column='parent_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_parent', to='core.Experiment'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['condition__internal_slug', 'workflow_step__internal_slug'])),
                ('condition', models.ForeignKey(blank=True, db_column='condition_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='condition_path_condition', to='core.Condition')),
                ('workflow_step', models.ForeignKey(blank=True, db_column='workflow_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='condition_path_workflow_step', to='core.WorkflowStep')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='condition_def',
            field=models.ForeignKey(db_column='condition_def_uuid', on_delete=django.db.models.deletion.CASCADE, related_name='condition_condition_def', to='core.ConditionDef'),
        ),
        migrations.AddField(
            model_name='condition',
            name='status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(blank=True, db_column='experiment_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bom_experiment', to='core.Experiment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bom', models.ForeignKey(blank=True, db_column='bom_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bom_material_bom', to='core.BillOfMaterials')),
                ('inventory_material', models.ForeignKey(blank=True, db_column='inventory_material_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bom_material_inventory_material', to='core.InventoryMaterial')),
                ('mixture', models.ForeignKey(blank=True, db_column='material_composite_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bom_composite_material_composite_material', to='core.Mixture')),
                ...
                ('vessel', models.ForeignKey(blank=True, db_column='vessel_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bom_material_vessel', to='core.Vessel')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='destination_material_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_unit_destination_material', to='core.BaseBomMaterial'),
        ),
        migrations.AddField(
            model_name='actionunit',
            name='source_material',
            field=models.ForeignKey(blank=True, db_column='source_material_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_unit_source_material', to='core.BaseBomMaterial'),
        ),
        migrations.AddField(
            model_name='actionunit',
            name='status',
        ...
        migrations.AddField(
            model_name='action',
            name='calculation_def',
            field=models.ForeignKey(blank=True, db_column='calculation_def_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_calculation_def', to='core.CalculationDef'),
        ),
        migrations.AddField(
            model_name='action',
            name='parameter_def',
        ...
        migrations.AddField(
            model_name='action',
            name='workflow',
            field=models.ForeignKey(blank=True, db_column='workflow_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_workflow', to='core.Workflow'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
