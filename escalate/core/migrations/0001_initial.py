# Generated by Django 3.0.14 on 2022-04-18 20:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('synonym', models.CharField(blank=True, db_column='synonym', max_length=255, null=True)),
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description'])),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_def', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_ad', to='core.ActionDef')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_unit_a', to='core.Action')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description', 'bom__internal_slug', 'inventory_material__internal_slug', 'vessel__internal_slug', 'reagent__internal_slug'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='descriptortemplate_actor', to='core.Actor')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_class', models.CharField(blank=True, choices=[('template', 'template'), ('model', 'model'), ('object', 'object')], max_length=64, null=True)),
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_volume', core.models.custom_types.ValField(blank=True, null=True)),
                ('well_number', models.IntegerField(blank=True, null=True)),
                ('column_order', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='children', to='core.Vessel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mod_date', models.DateTimeField(auto_now=True)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('uuid', core.models.core_tables.RetUUIDField(db_column='vessel_type_uuid', default=uuid.uuid4, primary_key=True, serialize=False)),
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description'])),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vesseltemplate_actor', to='core.Actor')),
                ('default_vessel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vessel_template_v', to='core.Vessel')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vesseltemplate_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vessel_instance_ei', to='core.ExperimentInstance')),
                ...
                ('vessel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vessel_instance_v', to='core.Vessel')),
                ('vessel_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vessel_instance_vt', to='core.VesselTemplate')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='vessel',
            name='vessel_type',
            field=models.ManyToManyField(blank=True, related_name='vessel_vessel_type', to='core.VesselType'),
        ),
        migrations.CreateModel(
            name='ValueInstance',
            fields=[
                ...
                ('outcome_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='value_instance_outcome', to='core.Outcome')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description'])),
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='type_actor', to='core.Actor')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='type_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('systemtool_type', models.ForeignKey(db_column='systemtool_type_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='systemtool_systemtool_type', to='core.SystemtoolType')),
                ('vendor_organization', models.ForeignKey(db_column='vendor_organization_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='systemtool_vendor_organization', to='core.Organization')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', models.ManyToManyField(blank=True, related_name='reagent_material_template_p', to='core.PropertyTemplate')),
                ('reagent_template', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_template_rt', to='core.ReagentTemplate')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagentmaterialtemplate_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagentmaterial_status', to='core.Status')),
                ('template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_material_rmt', to='core.ReagentMaterialTemplate')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='reagent',
            name='template',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reagent_rt', to='core.ReagentTemplate'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reagent', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='property_r', to='core.Reagent')),
                ('reagent_material', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='property_rm', to='core.ReagentMaterial')),
                ...
                ('template', models.ForeignKey(blank=True, db_column='property_def_uuid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='property_pt', to='core.PropertyTemplate')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='parameter_au', to='core.ActionUnit')),
        ...
        migrations.AddField(
            model_name='outcome',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='outcome_status', to='core.Status'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='organization_password_organization', to='core.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='NoteX',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', core.models.core_tables.RetUUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('value', core.models.custom_types.ValField(blank=True, null=True)),
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='moleculardescriptor_actor', to='core.Actor')),
                ('material', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='molecular_descriptor_m', to='core.Material')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='moleculardescriptor_status', to='core.Status')),
                ('template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='molecular_descriptor_dt', to='core.DescriptorTemplate')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_template_type', to='core.Type'),
        ),
        migrations.AddField(
            model_name='experimenttemplate',
            name='lab',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='experiment_template_ot', to='core.OutcomeTemplate'),
        ),
        migrations.AddField(
            model_name='experimenttemplate',
            name='owner',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='experiment_template_rt', to='core.ReagentTemplate'),
        ),
        migrations.AddField(
            model_name='experimenttemplate',
            name='status',
        ...
        migrations.AddField(
            model_name='experimenttemplate',
            name='vessel_templates',
            field=models.ManyToManyField(blank=True, related_name='experiment_template_vt', to='core.VesselTemplate'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='experimentinstance',
            name='template',
            field=models.ForeignKey(blank=True, db_column='parent_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_instance_template', to='core.ExperimentTemplate'),
        ),
        migrations.CreateModel(
            name='ExperimentDescriptor',
            fields=[
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('mod_date', models.DateTimeField(auto_now=True)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('uuid', core.models.core_tables.RetUUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='experimentdescriptor_actor', to='core.Actor')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='experimentdescriptor_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_action_sequence_et', to='core.ExperimentTemplate')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='experiment_action_sequence_child', to='core.ExperimentActionSequence')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='descriptortemplate',
            name='material_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='descriptor_template_mt', to='core.MaterialType'),
        ),
        migrations.AddField(
            model_name='descriptortemplate',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='descriptortemplate_status', to='core.Status'),
        ),
        migrations.AddField(
            model_name='descriptortemplate',
            name='systemtool',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='descriptor_template_st', to='core.Systemtool'),
        ),
        migrations.CreateModel(
            name='Contents',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bom_ei', to='core.ExperimentInstance')),
        ...
        migrations.AddField(
            model_name='basebommaterial',
            name='reagent',
            field=models.ForeignKey(blank=True, db_column='reagent_template_uuid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bom_material_reagent_template', to='core.ReagentTemplate'),
        ),
        migrations.AddField(
            model_name='basebommaterial',
            name='status',
        ...
        migrations.CreateModel(
            name='ActionTemplateDesign',
            fields=[
                ('uuid', core.models.core_tables.RetUUIDField(db_column='uuid', default=uuid.uuid4, primary_key=True, serialize=False)),
                ('id', models.CharField(blank=True, db_column='elsa_id', max_length=255, null=True)),
                ('description', models.CharField(blank=True, db_column='description', max_length=255, null=True)),
                ('source', models.CharField(blank=True, db_column='source', max_length=255, null=True)),
                ('destination', models.CharField(blank=True, db_column='destination', max_length=255, null=True)),
                ('top_position', models.CharField(blank=True, db_column='top', max_length=255, null=True)),
                ('left_position', models.CharField(blank=True, db_column='left', max_length=255, null=True)),
                ('order', models.IntegerField(db_column='sequence_order')),
                ('action_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template', to='core.ActionTemplate')),
            ],
        ),
        migrations.AddField(
            model_name='actiontemplate',
            name='actor',
            field=models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='actiontemplate_actor', to='core.Actor'),
        ),
        migrations.AddField(
            model_name='actiontemplate',
            name='dest_vessel_template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_dvt', to='core.VesselTemplate'),
        ),
        migrations.AddField(
            model_name='actiontemplate',
            name='experiment_template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_et', to='core.ExperimentTemplate'),
        ),
        migrations.AddField(
            model_name='actiontemplate',
            name='parent',
            field=models.ManyToManyField(blank=True, related_name='children', to='core.ActionTemplate'),
        ),
        migrations.AddField(
            model_name='actiontemplate',
            name='source_vessel_template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_svt', to='core.VesselTemplate'),
        ),
        migrations.AddField(
            model_name='actiontemplate',
            name='status',
            field=models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='actiontemplate_status', to='core.Status'),
        ),
        migrations.AddField(
            model_name='actionsequence',
            name='action_sequence_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_sequence_t', to='core.Type'),
        ),
        migrations.AddField(
            model_name='actionsequence',
            name='actor',
        ...
        migrations.AddField(
            model_name='actionsequence',
            name='experiment',
            field=models.ManyToManyField(related_name='action_sequence_e', through='core.ExperimentActionSequence', to='core.ExperimentTemplate'),
        ),
        migrations.AddField(
            model_name='actionsequence',
            name='status',
        ...
        migrations.AddField(
            model_name='action',
            name='experiment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_ei', to='core.ExperimentInstance'),
        ),
        migrations.AddField(
            model_name='action',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_child', to='core.Action'),
        ),
        migrations.AddField(
            model_name='action',
            name='status',
        ...
        migrations.AddField(
            model_name='action',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_t', to='core.ActionTemplate'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('selected_lab', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='custom_user_o', to='core.Organization')),
        ...
        migrations.CreateModel(
            name='ExperimentCompletedInstance',
            fields=[
            ],
            options={
                'proxy': True,
            ...
            bases=('core.experimentinstance',),
        ),
        migrations.CreateModel(
            name='ExperimentPendingInstance',
            fields=[
            ],
            options={
                'proxy': True,
