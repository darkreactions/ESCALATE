# Generated by Django 3.0.14 on 2022-03-14 07:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_slug', core.models.core_tables.SlugField(blank=True, editable=False, max_length=255, overwrite=True, populate_from=['description'])),
                ('action_sequence', models.ManyToManyField(related_name='experiment_template_as', through='core.ExperimentActionSequence', to='core.ActionSequence')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='experimentactionsequence',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='experiment_action_sequence_child', to='core.ExperimentActionSequence'),
        ),
        migrations.CreateModel(
            name='EdocumentX',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(blank=True, db_column='actor_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='actiontemplate_actor', to='core.Actor')),
                ('dest_vessel_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_dvt', to='core.VesselTemplate')),
                ('experiment_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_et', to='core.ExperimentTemplate')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_child', to='core.ActionTemplate')),
                ('source_vessel_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_template_svt', to='core.VesselTemplate')),
                ('status', models.ForeignKey(blank=True, db_column='status_uuid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='actiontemplate_status', to='core.Status')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_sequence', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_sequence', to='core.ActionSequence')),
            ],
        ),
        migrations.AddField(
