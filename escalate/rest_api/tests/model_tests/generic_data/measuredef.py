...
from core.models import MeasureDef, MeasureType, PropertyTemplate
        ...
        *[
        ...
        ],
        {
            ...
            "body": (
                request_body := random_model_dict(
                    MeasureDef,
                    default_measure_type="measuretype0__url",
        ...
        },
        {
            ...
            "body": (
                request_body := random_model_dict(
                    MeasureDef,
                    default_measure_type="measuretype1__url",
