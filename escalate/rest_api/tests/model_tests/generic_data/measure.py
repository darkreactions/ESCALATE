...
from core.models import MeasureDef, MeasureType, Measure
        ...
        *[
            {
                ...
                "body": (
                    request_body := random_model_dict(
                        Measure, measure_def="measuredef0__url"
                    )
                ),
                "args": [],
                "query_params": [],
        ...
        ],
        {
            ...
            "body": (
                request_body := random_model_dict(
                    Measure,
                    measure_type="measuretype0__url",
                    ref_measure="measure0__url",
                    measure_def="measuredef0__url",
                )
            ),
            "args": [],
            "query_params": [],
        ...
        },
        {
            ...
            "body": (
                request_body := random_model_dict(
                    Measure,
                    measure_type="measuretype1__url",
                    ref_measure="measure1__url",
                    measure_def="measuredef1__url",
                )
            ),
            "args": ["measure0__uuid"],
            "query_params": [],
