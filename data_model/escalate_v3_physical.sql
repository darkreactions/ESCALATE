...
ALTER TABLE "INGREDIENT" ADD CONSTRAINT "fk_INGREDIENT_COMPOUND_1" FOREIGN KEY ("compoundID") REFERENCES "AGGREGATE" ("coumpoundID");
...
ALTER TABLE "INGREDIENT" ADD CONSTRAINT "fk_INGREDIENT_INGREDIENTREF_1" FOREIGN KEY ("ingredientrefID") REFERENCES "INGREDIENTREF" ("ingredientrefID");
