...
ALTER TABLE "WORKFLOW" DROP CONSTRAINT "fk_WORKFLOW_ACTOR_1";
ALTER TABLE "ACTOR" DROP CONSTRAINT "fk_ACTOR_SYSTEM_1";
ALTER TABLE "ACTOR" DROP CONSTRAINT "fk_ACTOR_PERSON_1";
ALTER TABLE "DESCRIPTOR" DROP CONSTRAINT "fk_DESCRIPTOR_ACTOR_1";
ALTER TABLE "ORGANIZATION" DROP CONSTRAINT "fk_ORGANIZATION_PERSON_1";
ALTER TABLE "ORGANIZATION" DROP CONSTRAINT "fk_ORGANIZATION_SYSTEM_1";
ALTER TABLE "ACTION_PLAN" DROP CONSTRAINT "fk_ACTION_PLAN_EXPERIMENT_1";
ALTER TABLE "ACTION_INGREDIENT" DROP CONSTRAINT "fk_ACTION_INGREDIENT_AGGREGATE_1";
ALTER TABLE "ACTION_INGREDIENT" DROP CONSTRAINT "fk_ACTION_INGREDIENT_INGREDIENT_1";
ALTER TABLE "WORKFLOW" DROP CONSTRAINT "fk_WORKFLOW_STATUS_1";
ALTER TABLE "EXPERIMENT" DROP CONSTRAINT "fk_EXPERIMENT_STATUS_1";
...
ALTER TABLE "INGREDIENT" ADD CONSTRAINT "fk_INGREDIENT_COMPOUND_1" FOREIGN KEY ("aggregateID") REFERENCES "AGGREGATE" ("aggregateID");
...
ALTER TABLE "OUTCOME" ADD CONSTRAINT "fk_OUTCOME_COMPOUND_1" FOREIGN KEY ("compoundID") REFERENCES "AGGREGATE" ("aggregateID");
...
ALTER TABLE "WORKFLOW" ADD CONSTRAINT "fk_WORKFLOW_ACTOR_1" FOREIGN KEY ("actorID") REFERENCES "ACTOR" ("actorID");
ALTER TABLE "ACTOR" ADD CONSTRAINT "fk_ACTOR_SYSTEM_1" FOREIGN KEY ("systemID") REFERENCES "SYSTEM" ("systemID");
ALTER TABLE "ACTOR" ADD CONSTRAINT "fk_ACTOR_PERSON_1" FOREIGN KEY ("personID") REFERENCES "PERSON" ("personID");
ALTER TABLE "DESCRIPTOR" ADD CONSTRAINT "fk_DESCRIPTOR_ACTOR_1" FOREIGN KEY ("actorID") REFERENCES "ACTOR" ("actorID");
ALTER TABLE "ORGANIZATION" ADD CONSTRAINT "fk_ORGANIZATION_PERSON_1" FOREIGN KEY ("personID") REFERENCES "PERSON" ("personID");
ALTER TABLE "ORGANIZATION" ADD CONSTRAINT "fk_ORGANIZATION_SYSTEM_1" FOREIGN KEY ("systemID") REFERENCES "SYSTEM" ("systemID");
ALTER TABLE "ACTION_PLAN" ADD CONSTRAINT "fk_ACTION_PLAN_EXPERIMENT_1" FOREIGN KEY ("experimentID") REFERENCES "EXPERIMENT" ("experimentID");
ALTER TABLE "ACTION_INGREDIENT" ADD CONSTRAINT "fk_ACTION_INGREDIENT_AGGREGATE_1" FOREIGN KEY ("aggregateID") REFERENCES "AGGREGATE" ("aggregateID");
ALTER TABLE "ACTION_INGREDIENT" ADD CONSTRAINT "fk_ACTION_INGREDIENT_INGREDIENT_1" FOREIGN KEY ("ingredientID") REFERENCES "INGREDIENT" ("ingredientID");
ALTER TABLE "WORKFLOW" ADD CONSTRAINT "fk_WORKFLOW_STATUS_1" FOREIGN KEY ("statusID") REFERENCES "STATUS" ("statusID");
ALTER TABLE "EXPERIMENT" ADD CONSTRAINT "fk_EXPERIMENT_STATUS_1" FOREIGN KEY ("statusID") REFERENCES "STATUS" ("statusID");
