...
pg_dump -h `ipaddr` -O  -n 'dev' -U escalate -d escalate -Fp  -T 'dev.load_all*' -T 'dev.load_emo*'  -T 'dev.load_tie*' -T 'dev.load_vers*'  > escalate_dev_create_backup.sql
...
pg_dump -h `ipaddr` -O  -n 'dev' -U escalate -d escalate -Fp  -c -T 'dev.load_all*' -T 'dev.load_emo*'  -T 'dev.load_tie*' -T 'dev.load_vers*'  > escalate_dev_refresh_backup.sql
